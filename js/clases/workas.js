 ...
 *Se encargará de manejar los diferentes formulario de registro e inicio de sesión, poder listar los empleados de una empresa, poder crear, eliminar y modificar empleados,
 *mostrar un calendario con los días festivos, poder crear, listar y eliminar los anuncios del tablón de anuncios y mostrar los datos del usuario que ha iniciado sesión.
 */
var doc = document;
...
class Workas extends BD_Firebase {
    ...
    selecBtnEmpresa(btnEmpleado, btnEmpresa) {
        ...
        this.devolverConsultaFiltrarUsuarioId();
    }
        ...
        createUserWithEmailAndPassword(autentificacion, empleado.correo, empleado.codEmpleado)
            .then((credenciales) => {
                ...
                if (datos.docs[0] !== undefined) {
                    ...
                    doc.getElementById("errorLoginSingup").innerHTML = "(*) Error, el usuario no está asignado a ninguna empresa.";
    ...
    crearPaginaInicialWorkasEmpresa = async() => {
        ...
        //Añade la función de mostrar el calendario.
        ...
        //Añade la función de mostrar datos de la empresa que ha iniciado sesión al pasar el ratón por encima de la foto de perfil.
    ...
    //Muestra la página principal con todas las funciones correspondientes si se ha iniciado sesión como empleado.
    crearPaginaInicialWorkasEmpleado = async() => {
        ...
        //Añade la función de listar el tablón de anuncio que tiene la empresa.
